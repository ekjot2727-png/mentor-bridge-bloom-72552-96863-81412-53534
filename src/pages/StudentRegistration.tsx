  ...
  return (
    <div className="min-h-screen flex items-center justify-center pt-20">
      <div className="container mx-auto px-6">
        ...
        <Card className="max-w-2xl mx-auto glass-effect p-12 border border-primary/20">
          <div className="text-center mb-8">
            <GraduationCap className="h-16 w-16 text-primary mx-auto mb-4" />
            <h1 className="text-3xl font-bold mb-2 hero-text">Student Registration</h1>
            <p className="text-foreground/70">Join our community of ambitious students</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Popover open={open} onOpenChange={setOpen}>
                ...
                <PopoverContent className="w-full p-0 glass-effect border border-primary/20" align="start">
                  <Command>
